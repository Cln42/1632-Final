...
public class IslandEscape {
	...
	static String[] itemNames = { "Boat", "Fire", "Torch", "Log(s)", "Rope(s)", "Rock(s)",
			"Stick(s)", "Flint" };
	...
	/*
	 * If location has not been searched yet, get all items present and add them
	 * to inventory then set location as searched.
	 */
	...
	/*
	 * If user has enough items, they are subtracted from inventory and a torch is added.
	 */
	...
	/*
	 * If user has enough items, they are subtracted from inventory and a fire is added.
	 */
	...
	/*
	 * If user has enough items, they are subtracted from inventory and a boat
	 * is added. win() is called and program exits.
	 */
	...
	/*
	 * Parses user input to take appropriate response
	 */
	...
	/*
	 * Prints out commands for the user
	 */
	...
	/*
	 * Prints out welcome message for user
	 */
